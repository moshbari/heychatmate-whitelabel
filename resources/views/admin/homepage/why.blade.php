                    ...
                    <form action="{{ route('contents.create') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="details" class="form-control" value=""
                                id="exampleFormControlInput1" placeholder="Details" />
                        </div>

                        <div class="mb-3">
                            <label for="formFile" class="form-label">{{ $section_title }} Icon</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('contents.update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Current {{ $section_title }} Icon: </label>
                            <img id="wicon" src="" alt="icon" class="bg-primary">
                        </div>
...
@section('page-script')
    ...
    <script type="text/javascript">
        $('.edit').on('click', function() {
            ...
            modal.find('input[name=details]').val(data.text)
