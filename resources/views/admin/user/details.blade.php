...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Dashboard /</span> Manage Users / Details
    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <!-- Project table -->
            <div class="card mb-4">
                <h5 class="card-header">Update User Informations</h5>
                <div class="card-body">
                    ...
                    <form action="{{ route('user.update', $user->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlSelecta" class="form-label">Change Status</label>
                            <select class="form-select bg-danger text-white" id="exampleFormControlSelecta" name="status">
                                <option value="">Select Status</option>

                                        <option value="1" {{$user->status == 1?'selected':''}}>Active</option>

                                        <option value="0" {{$user->status != 1?'selected':''}}>Suspended</option>
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlSelect1" class="form-label">Change Role</label>
                            <select class="form-select bg-danger text-white" id="exampleFormControlSelect1" name="role">
