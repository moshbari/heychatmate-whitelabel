...
<body>
  <button class="chatbot-toggler">
    <span class="material-symbols-rounded open-btn">mode_comment</span>
  ...
  <div class="chatbot">
    ...
    <div id="Cbox">
      <ul class="chatbox">
        <li class="chat incoming">
          <img src="{{asset('assets/img/avatars/'.$assistant->avatar)}}" alt="" class="admin-icon">
    ...
    <div class="chatbox" id="infoBox">
      <form class="customer-input" id="infofrom">
        ...
        <input type="email" name="customer_email" class="css-input" id="cemail" placeholder="Enter Your Email*" required>
        @forelse ($assistant->formfields as $field)
        @if ($field->type == 'input')


        <input type="text" name="{{ $field->name }}" class="css-input" placeholder="{{ $field->label }}"
