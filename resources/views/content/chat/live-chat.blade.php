...
<script>
  function adjustScroll() {
    var height = 0;
      ...
      $('.chat-history-body').animate({scrollTop: height});
}
...
$(document).ready(function () {
  ...
  $(document).on("submit", "#submit-form", function(s) {
...
setTimeout(() => {
  $("#historyChat").append(`<li class="chat-message" id="typing">
    <div class="d-flex overflow-hidden">
              ...
              <li class="chat-contact-list-item active">
                <a class="d-flex align-items-center">
                  ...
                  <div class="chat-contact-info flex-grow-1 ms-3">
                    <h6 class="chat-contact-name text-truncate m-0">AI Chat</h6>
        ...
        <div class="col app-chat-history">
          <div class="chat-history-wrapper">
            ...
            <div class="chat-history-footer">
              <form class="form-send-message d-flex justify-content-between align-items-center" method="POST" action="{{route('chat-submit')}}" id="submit-form">
                {{ csrf_field() }}
