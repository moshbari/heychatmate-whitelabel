        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <p class="mb-4">Enter your valid email. System will send you a reset instruction to your registered email.</p>

        @include('content.alerts')

                        <form class="mb-3" action="{{ route('user.forgot.submit') }}" method="POST">
                            {{ csrf_field() }}
                            <div class="mb-3">
