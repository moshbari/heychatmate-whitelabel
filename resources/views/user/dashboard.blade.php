                ...
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            ...
                            <p class="mb-1">System has completed total <span class="fw-bold"> {{ $todays }} </span>
                                chats today. Check them now.</p>
                            <p class="mb-4">You have total <span class="fw-bold"> {{ auth()->user()->credit_balance }} </span>
                                Credits Left.</p>
                    ...
                    <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4 d-none d-sm-block">
                            <img src="{{ asset('assets/img/illustrations/3d-artificial-intelligence.png') }}" height="180"
                                alt="View Badge User">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0 bg-label-primary">
                            ...
                            @if (auth()->user()->hasActiveSubscription())
                                <h1 class="card-title text-nowrap mb-1">{{ auth()->user()->subscription->plan->name }}</h1>
                            @else
                                <span class="card-title text-nowrap mb-1">No Plan Taken</span>
                                <br>
                                 <a href="{{route('subscription.index')}}" class="btn btn-primary btn-sm mt-1">Prchase Plan</a>
                            @endif
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h1 class="card-title text-nowrap mb-1">{{ $last30 }}</h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0 bg-label-primary">
                                    <i class="dash-icons tf-icons bx bxs-message-dots bx-lg"></i>
                                </div>
                ...
                <div class="col-lg-4 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1">Credit Used Today</span>
                            <h1 class="card-title mb-2">{{ $todayscredit }}</h1>
                        </div>
                    </div>
                </div>
            </div>
