...
class Paypal extends Controller
{
    ...
    public static function initiate($request, $payment_data, $type)
    {
        ...
        $payment_data['checkout_session_id'] = $response->getTransactionReference();
        $dcontrol = new DepositController();
        $dcontrol->createPayment($payment_data);
    ...
    public function notify(Request $request)
    {
        ...
        $session_id = $responseData['paymentId'];
        ...
        return (new DepositController)->notifyOperation(['message' => $message, 'status' => $status, 'txn_id' =>$txn_id, 'session_id' => $session_id]);
