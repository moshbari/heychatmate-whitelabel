...
class Stripe
{
  ...
  public static function initiate($request, $payment_data, $type)
  {
    ...
    if ($checkout_session->id) {
      $payment_data['checkout_session_id'] = $checkout_session->id;
  ...
  public function notify(Request $request)
  {
    ...
    //dd($txn_id);
    return (new DepositController)->notifyOperation(['message' => $message, 'status' => $status, 'txn_id' => $txn_id, 'session_id' => $request->session_id]);
  }
}
