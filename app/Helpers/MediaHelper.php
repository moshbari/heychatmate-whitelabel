...
class MediaHelper
{
  ...
  public static function handleMakeImage($file, $resize_array = null, $ticket = false,$chat_icon = false)
  {
    $image_name = MediaHelper::imageNameValidation($file);
    $locaion = base_path('/public/assets/img/avatars/');
    if ($chat_icon) {
      $locaion = base_path('/public/assets/img/icons/hey-icons/');
    }
  ...
  // field is database field photo name
  // array is image resize width and height
  public static function handleProfileImage($file, $resize_array = null)
  {
    $image_name = MediaHelper::imageNameValidation($file);
    $locaion = base_path('/public/assets/img/profile/');
  ...
  // field is database field photo name
  // array is image resize width and height
  public static function handleSettingsImage($file, $field, $resize_array = null)
  {
    $image_name = MediaHelper::imageNameValidation($file);
    $locaion = base_path('/public/assets/front/images/home/');
